...
#Модели для хранения жанров книги
...
#Модели для хранения языков книг
...
#Модели для хранения авторов книг
...
class BookInstance(models.Model):
    ...
    inv_now = models.CharField(max_length=20, null=True, help_text='Введите инвентарный номер экземпляра', verbose_name='Инвентарный номер')
